...
namespace Veterinary.Infrastructure.Repositories
{
    public class UserRepository : IUserRepository
    {
        ...
        public UserRepository(VeterinaryContext context)
        {
        ...
        public async Task<IEnumerable<UserFullDto>> GetAll()
        {
            ...
            List<UserFullDto> userFullDtos = new();
            ...
            else
            {
                ...
                if (users != null)
                {
                    ...
                    foreach (var user in users)
                    {
                        ...
                        userFullDtos.Add(new UserFullDto
